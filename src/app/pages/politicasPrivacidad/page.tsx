    ...
    <div className="min-h-screen bg-[#0a0c10] text-white">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-5xl mx-auto space-y-16">
          <section>
            <h2 className="text-2xl font-semibold mb-6">Información general sobre privacidad</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-6">Tus derechos y opciones</h2>
            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-6">Seguridad y protección de datos</h2>
            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-6">Contacto y soporte</h2>
            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-4">
          ...
          <section className="border-t border-gray-800 pt-8">
            <p className="text-sm text-gray-400 text-center">Última actualización: {new Date().toLocaleDateString()}</p>
          </section>
        </div>
      </div>
    </div>
